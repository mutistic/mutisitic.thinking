...
import com.thinker.common.CommonEnums.DataType;
...
public class ValidateUtils {
	 ...
	 * @throws Exception
	 */
	public static boolean isEmpty(Object _data, DataType _dataType)
	{
		if(_data == null){
			return true;
		}

		if(_dataType == DataType.Character)
		{
		...
		else if(_dataType == DataType.List || _dataType == DataType.ArrayList || _dataType == DataType.LinkedList ||  _dataType == DataType.Vector)
		{
			/** List集合类型  **/
			return ((List)_data).isEmpty();
		}
		else if(_dataType == DataType.Map || _dataType == DataType.HashMap || _dataType == DataType.LinkedHashMap)
		{
			/** Map集合类型  **/
			return ((Map)_data).isEmpty();
		}
		else if(_dataType == DataType.Set || _dataType == DataType.HashSet || _dataType == DataType.LinkedHashSet)
		{
			/** Set集合类型  **/
